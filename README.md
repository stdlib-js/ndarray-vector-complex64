...
```javascript
var Complex64Vector = require( 'path/to/vendor/umd/ndarray-vector-complex64/index.js' )
```
...
[test-image]: https://github.com/stdlib-js/ndarray-vector-complex64/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/ndarray-vector-complex64/actions/workflows/test.yml?query=branch:v0.1.0
